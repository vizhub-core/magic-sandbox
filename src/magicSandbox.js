...
export default function (template, files, supress_console_log=false, is_https=true) {
  ...
  template = `<script>(function(){
    window.onerror = function(msg, url, lineNumber, colNumber, err) {
      window.parent.postMessage({type: "runtime-error", url:url, lineNumber:lineNumber, colNumber:colNumber, lineOffset:${lines}, message:msg, stack: err.stack}, "` + window.location.origin + `")
    }
